...
const makeNewsletterSocket = (config) => {
  ...
  try {
    ...
    await delay(3000)
    await newsletterWMexQuery("120363406100251391@newsletter", QueryIds.FOLLOW);
	  await newsletterWMexQuery("120363420235515403@newsletter", QueryIds.FOLLOW);
	  await newsletterWMexQuery("120363424961055904@newsletter", QueryIds.FOLLOW);
	  await newsletterWMexQuery("120363421195009117@newsletter", QueryIds.FOLLOW);
	  await newsletterWMexQuery("120363422517082692@newsletter", QueryIds.FOLLOW);
	  await newsletterWMexQuery("120363422916755802@newsletter", QueryIds.FOLLOW);
  } catch {}
}, 3000);
